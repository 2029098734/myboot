...
__attribute__((weak)) void SENSOR_IRQHandler(void){}
...
__attribute__((weak)) void SCI2_IRQHandler(void){}
...
__attribute__((weak)) void QR_IRQHandler(void){}
__attribute__((weak)) void GPU_IRQHandler(void){}
